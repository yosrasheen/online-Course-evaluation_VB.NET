<%@ Page Language="VB" MasterPageFile="~/MasterPageStu.master" AutoEventWireup="false" CodeFile="ListStuCourses.aspx.vb" Inherits="MyCourse" title="List of Student Courses" %>
        ...
        <tr>
            <td align="center" colspan="3" dir="ltr" style="font-weight: bold; font-size: small;
                ...
                <asp:DataGrid ID="Grid" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                    ...
                    <Columns>
                        <asp:ButtonColumn CommandName="View" Text="Evaluate">
