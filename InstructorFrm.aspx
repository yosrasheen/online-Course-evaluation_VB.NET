<%@ Page Language="VB" MasterPageFile="~/MasterPageInst.master" AutoEventWireup="false" CodeFile="InstructorFrm.aspx.vb" Inherits="InstructorFrm" title="Instructor Form" %>
        ...
        <tr>
            <td align="center" colspan="1" dir="ltr" style="font-weight: normal; font-size: x-small;
                ...
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Font-Underline="False" ForeColor="DeepSkyBlue" NavigateUrl="~/EditInstructor.aspx">Edit Profile</asp:HyperLink></td>
            <td align="center" colspan="3" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
                &nbsp;<asp:HyperLink ID="lnkIns" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Font-Underline="False" ForeColor="DeepSkyBlue" NavigateUrl="~/ListInstCourses.aspx">Lit of My Courses</asp:HyperLink></td>
            <td align="center" colspan="1" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
