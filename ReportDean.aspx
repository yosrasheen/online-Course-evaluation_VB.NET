<%@ Page Language="VB" MasterPageFile="~/MasterPageDean.master" AutoEventWireup="false" CodeFile="ReportDean.aspx.vb" Inherits="ReportDean" title="View Reports" %>
        ...
        <tr>
            <td align="left" style="width: 1000px">
                <asp:Label ID="lblName" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"
                    ForeColor="#69BDE1" Text="Label" Width="112px"></asp:Label></td>
        </tr>
    </table>
    <br />
