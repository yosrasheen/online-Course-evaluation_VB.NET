<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="ManageDeanAcc.aspx.vb" Inherits="ManageDeanAcc" title="Deanship Account" %>
    ...
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" style="border-right: #69bde1 thin ridge;
        ...
        <tr>
            <td align="center" colspan="3" dir="rtl" style="font-weight: bold; height: 28px">
                <asp:LinkButton ID="lnkAdd" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small">Press Here to Add New Deanship</asp:LinkButton></td>
        </tr>
    </table>
    <br />
