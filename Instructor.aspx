<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="Instructor.aspx.vb" Inherits="Instructor" title="Instructor Account" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" dir="ltr"
        ...
        <tr>
            <td align="left" dir="ltr" style="font-weight: bold; font-size: small; width: 879px;
                font-family: Arial; height: 18px">
                <asp:Label ID="lblErrName" runat="server" Font-Bold="True" ForeColor="Red" Text="Instructor Name Error"
        ...
        <tr>
            <td align="left" colspan="3" dir="ltr" style="font-weight: bold; font-size: small;
                font-family: Arial; color: white; height: 5px; background-color: #a4b1c8;" bgcolor="#dcdcdc">
                List of Courses</td>
        </tr>
        <tr>
            <td align="center" colspan="3" dir="ltr" style="font-weight: bold; font-size: small;
                font-family: Arial; height: 157px">
                ...
                <asp:DataGrid ID="Grid" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                    ...
                    <AlternatingItemStyle BackColor="White" />
                    <ItemStyle BackColor="#FFFBD6" Font-Names="arial" Font-Size="Small"
                ...
                <asp:Label ID="lblErr" runat="server" Font-Names="Arial" Font-Size="Small" ForeColor="Red"
                    Text="No Courses Assigned" Width="216px"></asp:Label><br />
            </td>
        </tr>
        <tr>
            <td align="right" colspan="3" dir="ltr" style="font-weight: bold; font-size: small;
                ...
                <asp:Button ID="btnSave" runat="server" BackColor="#69BDE1" Font-Bold="True" Font-Size="Small"
                    Height="32px" Text="SAVE" Width="80px" />
            </td>
        </tr>
    </table>
</asp:Content>
