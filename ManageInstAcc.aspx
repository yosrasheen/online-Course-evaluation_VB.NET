<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="ManageInstAcc.aspx.vb" Inherits="ManageAcc" title="Instructors Accounts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" style="border-right: #69bde1 thin ridge;
        ...
        <tr>
            <td align="center" colspan="3" dir="rtl" style="font-weight: bold; height: 28px">
                <asp:LinkButton ID="lnkAdd" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small">Press Here to Add New Instructor</asp:LinkButton></td>
        </tr>
    </table>
    ...
    <asp:DataGrid ID="Grid" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
        ...
        <Columns>
            <asp:ButtonColumn CommandName="Select" Text="Edit">
