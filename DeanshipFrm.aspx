<%@ Page Language="VB" MasterPageFile="~/MasterPageDean.master" AutoEventWireup="false" CodeFile="DeanshipFrm.aspx.vb" Inherits="DeanshipFrm" title="Deanship Form" %>
    ...
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" dir="ltr"
        ...
        <tr>
            ...
            <td align="center" colspan="3" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
                <img height="120" src="images/Report.jpg" width="120" /></td>
            <td align="center" colspan="1" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
        ...
        <tr>
            <td align="center" colspan="1" dir="ltr" style="font-weight: normal; font-size: x-small;
                ...
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Font-Underline="False" ForeColor="DeepSkyBlue" NavigateUrl="~/EditDeanship.aspx">Edit Profile</asp:HyperLink></td>
            <td align="center" colspan="3" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
                &nbsp;<asp:HyperLink ID="lnkIns" runat="server" Font-Bold="True" Font-Names="Arial"
                    Font-Size="Medium" Font-Underline="False" ForeColor="DeepSkyBlue" NavigateUrl="~/ReportDean.aspx">Generate Reports</asp:HyperLink></td>
            <td align="center" colspan="1" dir="ltr" style="font-weight: normal; font-size: x-small;
                color: red; font-family: Arial">
