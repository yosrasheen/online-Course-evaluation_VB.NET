<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="ManageStuAcc.aspx.vb" Inherits="ManageStuAcc" title="Students Accounts" %>
    ...
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" style="border-right: #69bde1 thin ridge;
        ...
        <tr>
            <td align="center" colspan="3" dir="rtl" style="font-weight: bold; height: 28px">
                <asp:LinkButton ID="lnkAdd" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small">Press Here to Add New Student</asp:LinkButton></td>
        </tr>
    </table>
