<%@ Page Language="VB" MasterPageFile="~/MasterPageDean.master" AutoEventWireup="false" CodeFile="EditDeanship.aspx.vb" Inherits="EditDeanship" title="Edit Deanship Profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="Table1" align="center" border="0" cellpadding="1" cellspacing="1" dir="ltr"
        ...
        <tr>
            <td align="left" bgcolor="#a7d3ec" colspan="3" dir="ltr" style="font-weight: bold;
        ...
        <tr>
            <td align="left" dir="ltr" style="font-weight: bold; font-size: small; width: 879px;
                color: red; font-family: Arial; height: 11px">
                <asp:TextBox ID="txtNo" runat="server" BackColor="#E0E0E0" BorderStyle="Inset" ReadOnly="True"
