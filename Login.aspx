    ...
    <div align="center">
        <table id="Table11" align="center" border="0" cellpadding="0"
            ...
            <tr>
                ...
                <td align="left" colspan="2" dir="ltr" style="font-weight: bold; height: 20px">
                    &nbsp;<asp:LinkButton ID="lnkPassword" runat="server" ForeColor="Red">Forget Password</asp:LinkButton></td>
                <td align="center" colspan="1" dir="ltr" style="font-weight: bold; height: 20px">
                </td>
            </tr>
        </table>
